...
var PlotBase = /** @class */ (function (_super) {
    ...
    PlotBase.prototype.render = function () {
        ...
        if (this.props.bookmark.dict[specKey]) {
            notesDiv = (React.createElement("textarea", { styleName: 'note', placeholder: 'notes', value: this.props.bookmark.dict[specKey].note, onChange: this.handleTextChange }));
        }
