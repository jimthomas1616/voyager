...
var FieldListBase = /** @class */ (function (_super) {
    ...
    FieldListBase.prototype.render = function () {
        var _this = this;
        var _a = this.props, config = _a.config, fieldDefs = _a.fieldDefs, schema = _a.schema;
        ...
        return (React.createElement("div", { styleName: (config.wildcards === 'disabled') ? 'field-list-no-wildcards' : 'field-list' }, fieldItems));
    };
