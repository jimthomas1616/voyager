...
var EncodingPanelBase = /** @class */ (function (_super) {
    ...
    EncodingPanelBase.prototype.encodingShelf = function (channel) {
        ...
        return (React.createElement(encoding_shelf_1.EncodingShelf, { key: channel, id: { channel: channel }, fieldDef: encoding[channel], schema: schema, handleAction: handleAction, valueDef: encoding[channel] }));
    };
    ...
    EncodingPanelBase.prototype.wildcardShelf = function (index) {
        ...
        return (React.createElement(encoding_shelf_1.EncodingShelf, { key: index, id: id, schema: schema, fieldDef: anyEncodings[index], handleAction: handleAction, valueDef: undefined }));
    };
