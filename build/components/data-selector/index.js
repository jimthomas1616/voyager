...
var DataSelectorBase = /** @class */ (function (_super) {
    ...
    DataSelectorBase.prototype.render = function () {
        ...
        return (React.createElement("span", { styleName: 'data-selector' },
            ...
            React.createElement(react_modal_1.default, { isOpen: this.state.modalIsOpen, onRequestClose: this.closeModal, contentLabel: "Data Selector", styleName: "modal" },
