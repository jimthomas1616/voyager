...
;
var EncodingShelfBase = /** @class */ (function (_super) {
    __extends(EncodingShelfBase, _super);
    function EncodingShelfBase(props) {
        var _this = _super.call(this, props) || this;
        _this.popupRefHandler = function (ref) {
            _this.fieldCustomizer = ref;
        };
        _this.fieldHandler = function (ref) {
            _this.encodingShelf = ref;
        };
        _this.state = {
        ...
        _this.toggleCustomizer = _this.toggleCustomizer.bind(_this);
        return _this;
    }
    EncodingShelfBase.prototype.componentWillUpdate = function (nextProps, nextState) {
        if (!nextState) {
            return;
        }
        ...
        return connectDropTarget(React.createElement("div", { styleName: isWildcardShelf ? 'wildcard-shelf' : 'encoding-shelf' },
            React.createElement("div", { styleName: "shelf-label" },
                React.createElement(TetherComponent, { attachment: "top left", targetAttachment: "bottom left" },
                    (fieldDef && !encoding_1.isWildcardChannelId(id) && util_1.contains(property_editor_schema_1.CUSTOMIZABLE_ENCODING_CHANNELS, id.channel)) ?
                        React.createElement("span", { onClick: this.toggleCustomizer, ref: this.fieldHandler },
                            channelName,
                            ' ',
                            " ",
                    ...
                    this.state.customizerIsOpened &&
                        React.createElement("div", { ref: this.popupRefHandler },
    ...
    EncodingShelfBase.prototype.handleClickOutside = function (e) {
    ...
    EncodingShelfBase.prototype.closePopup = function () {
        this.setState({
            customizerIsOpened: false
        });
    };
