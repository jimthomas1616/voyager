...
function resultPlotSpecModifyFieldReducer(encoding, action) {
    var _a, _b;
    var _c = action.payload, channel = _c.channel, prop = _c.prop, value = _c.value;
    ...
    switch (action.type) {
        case result_1.RESULT_MODIFY_FIELD_PROP:
            return __assign({}, encoding, (_a = {}, _a[channel] = spec_1.modifyFieldProp(fieldDef, prop, value), _a));
        case result_1.RESULT_MODIFY_NESTED_FIELD_PROP: {
            var nestedProp = action.payload.nestedProp;
            return __assign({}, encoding, (_b = {}, _b[channel] = spec_1.modifyNestedFieldProp(fieldDef, prop, nestedProp, value), _b));
        }
    }
    return encoding;
}
